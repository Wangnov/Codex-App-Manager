...
const FR: Record<Key, string> = {
  ...
  "home.installedDate": "Installé le",
  "home.update.title": "Mise à jour disponible",
  "home.update.flow": "Actuelle {from} → Nouvelle {to}",
  "home.update.size": "~{size}",
  ...
  "uninstall.keepDataNote": "Connexion, sessions et configuration (~/.codex) sont conservées ; une réinstallation reprend où vous en étiez.",
  ...
  "uninstall.confirm1.bodyKeep": "L'application Codex sera supprimée ; vos données (~/.codex) sont conservées et disponibles après réinstallation.",
...
const ZH_TW: Record<Key, string> = {
  ...
  "home.installedDate": "安裝時間",
  "home.update.title": "有新版本可更新",
  "home.update.flow": "目前 {from} → 新版 {to}",
  ...
  "uninstall.keepDataNote":
    "登入狀態、工作階段與設定（~/.codex）都會保留；重新安裝後可繼續使用。",
  ...
  "uninstall.confirm1.bodyKeep":
    "將從你的電腦移除 Codex 應用程式；你的資料（~/.codex）會保留，重新安裝後可繼續使用。",
...
const DE: Record<Key, string> = {
  ...
  "home.installedDate": "Installiert am",
  "home.update.title": "Update verfügbar",
  "home.update.flow": "Aktuell {from} → Neu {to}",
  "home.update.size": "~{size}",
  ...
  "uninstall.keepDataNote":
    "Anmeldung, Sitzungen und Konfiguration (~/.codex) bleiben erhalten; nach einer Neuinstallation kannst du weitermachen.",
  ...
  "uninstall.confirm1.bodyKeep":
    "Die Codex App wird entfernt; deine Daten (~/.codex) bleiben erhalten und sind nach einer Neuinstallation wieder verfügbar.",
...
const KO: Record<Key, string> = {
  ...
  "home.installedDate": "설치일",
  "home.update.title": "업데이트 있음",
  "home.update.flow": "현재 {from} → 새 버전 {to}",
  ...
  "uninstall.keepDataNote":
    "로그인 상태, 세션 및 구성(~/.codex)이 보존되며, 재설치 후에도 이어서 사용할 수 있습니다.",
  ...
  "uninstall.confirm1.bodyKeep":
    "Codex 앱이 제거되며, 데이터(~/.codex)는 보존되어 재설치 후에도 이어서 사용할 수 있습니다.",
...
const JA: Record<Key, string> = {
  ...
  "home.installedDate": "インストール日",
  "home.update.title": "アップデートがあります",
  "home.update.flow": "{from} → {to} へ",
  "home.update.size": "約 {size}",
  ...
  "uninstall.keepDataNote": "サインイン情報、セッション、設定（~/.codex）は保持されます。再インストール後も続きから使えます。",
  ...
  "uninstall.confirm1.bodyKeep": "Codex アプリを削除します。データ（~/.codex）は保持され、再インストール後に引き続き使用できます。",
...
const RU: Record<Key, string> = {
  ...
  "home.installedDate": "Установлено",
  "home.update.title": "Доступно обновление",
  "home.update.flow": "Сейчас {from} → Новая {to}",
  "home.update.size": "~{size}",
  ...
  "uninstall.keepDataNote": "Данные для входа, сессии и конфигурация (~/.codex) сохранятся; после переустановки всё продолжит работать.",
  ...
  "uninstall.confirm1.bodyKeep": "Приложение Codex будет удалено; ваши данные (~/.codex) сохранятся и будут доступны после переустановки.",
...
const AR: Record<Key, string> = {
  ...
  "home.installedDate": "تاريخ التثبيت",
  "home.update.title": "تحديث متاح",
  "home.update.flow": "الحالي {from} ← جديد {to}",
  "home.update.size": "~{size}",
  ...
  "uninstall.keepDataNote": "سيُحتفظ بتسجيل الدخول والجلسات والإعدادات (~/.codex)؛ يمكن استئنافها بعد إعادة التثبيت.",
  ...
  "uninstall.confirm1.bodyKeep": "سيُزال تطبيق Codex؛ بياناتك (~/.codex) ستُحتفظ وتُستأنف بعد إعادة التثبيت.",
...
const ES: Record<Key, string> = {
  ...
  "home.installedDate": "Instalado el",
  "home.update.title": "Actualización disponible",
  "home.update.flow": "Actual {from} → Nueva {to}",
  "home.update.size": "~{size}",
  ...
  "uninstall.keepDataNote": "El inicio de sesión, las sesiones y la configuración (~/.codex) se conservan; al reinstalar, continúas donde lo dejaste.",
  ...
  "uninstall.confirm1.bodyKeep": "Se eliminará la app Codex; tus datos (~/.codex) se conservarán y estarán disponibles tras reinstalar.",
...
const PT_BR: Record<Key, string> = {
  ...
  "home.installedDate": "Instalado em",
  "home.update.title": "Atualização disponível",
  "home.update.flow": "Atual {from} → Novo {to}",
  "home.update.size": "~{size}",
  ...
  "uninstall.keepDataNote": "Login, sessões e configurações (~/.codex) são mantidos; reinstalar retoma de onde parou.",
  "uninstall.confirm": "Desinstalar",
  "uninstall.cancel": "Cancelar",
  "uninstall.working": "Desinstalando…",
  "uninstall.continue": "Continuar",
  ...
  "uninstall.confirm1.title": "Desinstalar Codex?",
  "uninstall.confirm1.bodyKeep": "Isso remove o aplicativo Codex; seus dados (~/.codex) são mantidos e retomados após reinstalar.",
