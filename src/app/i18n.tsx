...
const ZH = {
  ...
  "progress.paused.hint": "点「继续」从上次的位置接着下载",
...
const EN: Record<Key, string> = {
  ...
  "progress.paused.hint": "Resume to pick up where you left off",
...
const FR: Record<Key, string> = {
  ...
  "progress.paused.hint": "Reprenez pour continuer là où vous vous êtes arrêté",
...
const ZH_TW: Record<Key, string> = {
  ...
  "progress.paused.hint": "點「繼續」從上次的位置接著下載",
...
const DE: Record<Key, string> = {
  ...
  "progress.paused.hint": "Fortsetzen, um dort weiterzumachen, wo du aufgehört hast",
...
const KO: Record<Key, string> = {
  ...
  "progress.paused.hint": "이어서 받으려면 계속을 누르세요",
...
const JA: Record<Key, string> = {
  ...
  "progress.paused.hint": "「再開」で続きからダウンロードします",
...
const RU: Record<Key, string> = {
  ...
  "progress.paused.hint": "Нажмите «Продолжить», чтобы возобновить загрузку",
...
const AR: Record<Key, string> = {
  ...
  "progress.paused.hint": "اضغط استئناف لمتابعة التنزيل من حيث توقفت",
...
const ES: Record<Key, string> = {
  ...
  "progress.paused.hint": "Reanuda para continuar donde lo dejaste",
...
const PT_BR: Record<Key, string> = {
  ...
  "progress.paused.hint": "Retome para continuar de onde parou",
