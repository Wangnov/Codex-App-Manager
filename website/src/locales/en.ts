export default {
  ...
  download: {
    ...
    signing: {
      status: "Windows Authenticode is being migrated to SignPath Foundation. New Windows releases remain fail-closed until the trusted build and real artifacts are verified.",
      attributionNote: "Required attribution after approval; this does not claim current downloads are signed:",
